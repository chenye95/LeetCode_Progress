...
def getFolderNames(names: List[str]) -> List[str]:
    ...
    for name in names:
        ...
        k_value[name] = k
        return_list.append(unique_name)
        seen.add(unique_name)
    return return_list


assert getFolderNames(["wano", "wano", "wano", "wano"]) == ["wano", "wano(1)", "wano(2)", "wano(3)"]
assert getFolderNames(["pes", "fifa", "gta", "pes(2019)"]) == ["pes", "fifa", "gta", "pes(2019)"]
assert getFolderNames(["gta", "gta(1)", "gta", "avalon"]) == ["gta", "gta(1)", "gta(2)", "avalon"]
assert getFolderNames(["onepiece", "onepiece(1)", "onepiece(2)", "onepiece(3)", "onepiece"]) == \
