...
for test_course_count, test_prerequisites, expected_out in test_cases:
    assert find_order(num_courses=test_course_count, prerequisites=test_prerequisites) in expected_out
