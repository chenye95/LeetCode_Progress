...
itinerary in order. All tickets belong to a man who departs from JFK. Thus, the itinerary must begin with JFK.
...
def find_itinerary(tickets: List[Tuple[str, str]]) -> List[str]:
    ...
    for from_city, to_city in sorted(tickets, reverse=True):
        connection_map[from_city].append(to_city)
...
test_cases = [
    ([("ATL", "BOS"), ("BOS", "ZRH"), ("JFK", "ATL"), ("ZRH", "BOS"), ("BOS", "JFK")],
